...
namespace Common
{
    public class ProjectServerTelegram
    {
        private string _userName;
        private string _userPassword;

        private string _siteUri;
        public ProjectServerTelegram(string userName, string password)
        {
            _userName = userName;
        ...
        public IMessageActivity GetAllProjectsBasic(IDialogContext dialogContext, int SIndex, bool showCompletion, bool ProjectDates, bool PDuration, bool projectManager, out int Counter)
        {
            IMessageActivity reply = null;
            reply = dialogContext.MakeMessage();
            reply.AttachmentLayout = AttachmentLayoutTypes.Carousel;
